...
const currencies1: Currency<string> = ["NZD", "THB", "NGN"];
...
const populations2: Array<NumberInput> = [
  5_135_300, 331_893_745, 1_412_600_000,
];
...
const countries1: Array<{ name: string; code: string; population: number }> = [
  {
    name: "China",
    code: "CN",
